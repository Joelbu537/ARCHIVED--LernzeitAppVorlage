...
public partial class LoginPage : ContentPage
{
	...
	private async void OnLoginClicked(object sender, EventArgs e)
	{
		...
		if(email.Length >= 26 && email.Contains("@lmg.schulen-lev.de") && password.Length >= 6)
		{
			...
			GC.Collect();
            password = "";
            //Verbindung zu Datenbanktool aufbauen und Logindaten verifzieren
            await Navigation.PushModalAsync(new HomePage());//ADD PAGE
        }
		else
		{
